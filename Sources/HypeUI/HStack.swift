...
/// - Returns: horizontal stack view
public func HStack(alignment: UIStackView.Alignment = .fill, spacing: CGFloat = 0.0, @ViewArrayBuilder _ content: () -> [UIView]) -> UIStackView {
